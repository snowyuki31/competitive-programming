...
int main()
{
    ...
    while(K--){ 
        ...
        rep(_, ct) deq.push_back(last);
        rep(_, ct) deq.pop_front(), deq.push_back(last);
    }

    string res = "";
    while (!deq.empty()) res += deq.front(), deq.pop_front();
