...
struct Graph {
    ...
    void add_edge(int a, int b, double w = 1){
        G[a].emplace_back(a, b, w);
        G[b].emplace_back(b, a, w);
    }

    void add_arrow(int a, int b, double w = 1){
        G[a].emplace_back(a, b, w);
    }
    ...
    vector<double> dijkstra(ll s, bool restore = false) const;
